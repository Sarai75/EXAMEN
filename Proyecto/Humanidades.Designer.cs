...
namespace Proyecto
{
	partial class Humanidades
	{
		...
		private void InitializeComponent()
		{
			...
			this.label3.Text = "¿QUÉ ES EL BIEN?\r\n";
			// 
			// label4
			// 
			...
			this.label7.Text = "Para Platón el bien es una idea que solo existe en un mundo imperceptible y solo " +
